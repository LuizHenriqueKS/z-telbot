...
import ZTelBotListenUpdatesOptions from './core/update/ZTelBotListenUpdatesOptions';
...
export { default as ZTelBotListenUpdatesOptions } from './core/update/ZTelBotListenUpdatesOptions';
